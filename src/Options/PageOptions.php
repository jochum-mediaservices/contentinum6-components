...
class PageOptions extends AbstractOptions
{
    ...
    protected $routeParams = array('pages','section','article','category','categoryvalue');
    ...
    {
        $this->id = $id;
        $this->addParameter('pageIdent', $id);
    }
    ...
    public function addPageHeaders($pageHeaders)
    {
        ...
        foreach ($pageHeaders as $link){
            $this->pageHeaders[] = $link;
        }
    }
